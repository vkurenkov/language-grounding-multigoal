...
# Computational model
from experiments.dueling_dqn_cat.model 	   import Model
from experiments.dueling_dqn_cat.model      import prepare_model_input
from experiments.dueling_dqn_cat.parameters import device

# Prioritized eperience replay
from experiments.dueling_dqn_cat.replay     import Replay
		...
		for layout in layouts:
			...
			for instruction in instructions:
				...
				for t, epoch in enumerate(trajectory):
					...
					replay.append((epoch_obs, epoch_action, epoch_reward))
...
def start_training(erase_folder=None):
	...
	from experiments.dueling_dqn_cat.parameters import test_parameters
	from experiments.dueling_dqn_cat.parameters import create_experiment_folder

	# Experimental environment and layouts
	from experiments.dueling_dqn_cat.parameters import env_definition
