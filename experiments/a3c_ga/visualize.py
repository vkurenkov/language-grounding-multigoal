...
# Target environment
from experiments.a3c_ga.parameters import env_definition

# Instructions
from experiments.a3c_ga.parameters import instructions
from experiments.a3c_ga.parameters import instructions_level
from experiments.a3c_ga.parameters import tokenizer

# Agent's training and testing parameters
from experiments.a3c_ga.parameters import train_parameters
from experiments.a3c_ga.parameters import test_parameters
from experiments.a3c_ga.parameters import experiment_folder
from experiments.a3c_ga.parameters import TEST_MODE_STOCHASTIC
from experiments.a3c_ga.parameters import TEST_MODE_DETERMINISTIC

# Load the computational model
from experiments.a3c_ga.model import A3C_LSTM_GA
